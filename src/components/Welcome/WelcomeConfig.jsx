...
const WelcomeConfig = ({ onShowAppContent }) => {
  return (
    ...
    <div className="overlay">
      ...
      <button onClick={onShowAppContent} className='catalog-button'>Ver catalogo</button>
      <div>
      <a href="https://www.instagram.com/jaklof_/" target="_blank" rel="noopener noreferrer">
